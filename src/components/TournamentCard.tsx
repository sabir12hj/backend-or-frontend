...
const TournamentCard = ({
  ...
  const memoizedDate = React.useMemo(
    () => targetDate,
    [tournament.startTime, tournament.endTime, isLive]
  );
  ...
  const imageMap: Record<string, string> = {
    ...
    Sports:
      "https://images.unsplash.com/photo-1613202968096-38809315aa2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    Movies:
      "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    Science:
      "https://images.unsplash.com/photo-1605711285791-0219e80e43a3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
  };
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow">
      <div className="relative">
        ...
        <div
          className={`absolute top-0 right-0 ${
            isLive ? "bg-green-600" : "bg-yellow-600"
          } text-white rounded-bl-lg px-3 py-1`}
        >
          <span className="font-bold">{isLive ? "LIVE NOW" : "UPCOMING"}</span>
        </div>
      </div>
      ...
      <div className="p-5">
        ...
        <Link to={`/tournaments/${tournament.id}`}>
          <Button className="w-full" variant={isLive ? "default" : "secondary"}>
